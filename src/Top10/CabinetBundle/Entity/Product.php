...
/**
 * Top10\CabinetBundle\Entity\Product
 *
 * @ORM\Table(indexes={@ORM\Index(name="article", columns={"article"})})
 * @ORM\Entity(repositoryClass="Top10\CabinetBundle\Entity\ProductRepository")
 */
class Product
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="ProductsOrders", mappedBy="Product")
     */
	...
	/**
     * @ORM\ManyToOne(targetEntity="Factory", inversedBy="product")
     * @ORM\JoinColumn(name="factory_id", referencedColumnName="id")
     */
    private $factory;

	/**
     * @ORM\ManyToOne(targetEntity="Model", inversedBy="product")
